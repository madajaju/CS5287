...
Video: link:https://youtu.be/yapubtE2bfs[https://youtu.be/yapubtE2bfs]

=== Video Chapters

* link:https://youtu.be/yapubtE2bfs?t=0[00:00 — Foundations and basic building blocks]
* link:https://youtu.be/yapubtE2bfs?t=364[06:04 — Bridge, host, and container networking modes]
* link:https://youtu.be/yapubtE2bfs?t=766[12:46 — BGP, service meshes, and CNI]
* link:https://youtu.be/yapubtE2bfs?t=1084[18:04 — DNS, security, and best practices]
...
image::BasicContainerNetworkingDiagram.png[BasicContainerNetworkingDiagram.png]
...
image::CNIPluginWorkflowDiagram-CNI_Plugin_Workflow.png[CNIPluginWorkflowDiagram-CNI_Plugin_Workflow.png]
...
image::bridge.png[Default Docker bridge network]
...
image::host_networking_mode_diagram-Host_Networking_Mode.png[host_networking_mode_diagram-Host_Networking_Mode.png]
...
image::MacVLAN_IPVLAN_Networking_Diagram-MacVLAN___IPVLAN_Networking.png[MacVLAN_IPVLAN_Networking_Diagram-MacVLAN___IPVLAN_Networking.png]
...
image::overlay_network_v_x_l_a_n.png[overlay_network_v_x_l_a_n.png]
...
image::b_g_p_route_based_container_networking_diagram.png[b_g_p_route_based_container_networking_diagram.png]
...
image::service_mesh_with_sidecar_proxies-Service_Mesh_with_Sidecar_Proxies.png[service_mesh_with_sidecar_proxies-Service_Mesh_with_Sidecar_Proxies.png]
...
image::c_n_i_plugin_workflow_diagram.png[c_n_i_plugin_workflow_diagram.png]
