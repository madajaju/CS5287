...
Video: link:https://youtu.be/t8fdQfGeHuU[Containers: Key Principles and Concepts]

== Video Chapters

* link:https://youtu.be/t8fdQfGeHuU?t=0[00:00 — Container history and evolution]
* link:https://youtu.be/t8fdQfGeHuU?t=241[04:01 — Container images and layered filesystems]
* link:https://youtu.be/t8fdQfGeHuU?t=606[10:06 — Security, orchestration, and best practices]
