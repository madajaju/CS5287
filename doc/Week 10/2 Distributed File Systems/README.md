# Lecture: Distributed File Systems in Multi-Hybrid Cloud Environments
...
*Multi-hybrid cloud DFS showing data partitions replicated across public clouds and on-premises sites, with arrows representing replication and synchronization.*
...
- **Ceph Example:** Deploying Ceph storage clusters spanning an on-premises data center and AWS, replicating file partitions to provide low-latency access for applications running in both environments.
