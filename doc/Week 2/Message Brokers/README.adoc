...
Video: link:https://youtu.be/WLzM6KNcfik[https://youtu.be/WLzM6KNcfik]

image::messagebroker-Generalized_Message_Broker_Architecture.png[messagebroker-Generalized_Message_Broker_Architecture.png]
...
image::point-tp-point-Point_to_Point_Messaging_Pattern.png[point-tp-point-Point_to_Point_Messaging_Pattern.png]
...
image::pubsub-Publish_Subscribe_Messaging_Pattern.png[pubsub-Publish_Subscribe_Messaging_Pattern.png]
...
image::topic_based_messaging_pattern-Routing___Topic_Based_Messaging_Pattern.png[topic_based_messaging_pattern-Routing___Topic_Based_Messaging_Pattern.png]
...
image::request_reply_messaging_pattern-Request_Reply_Messaging_Pattern.png[request_reply_messaging_pattern-Request_Reply_Messaging_Pattern.png]
