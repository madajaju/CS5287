...
== Process Management
  ...
  Video: link:https://youtu.be/gKxkOrSK0Fs[https://youtu.be/gKxkOrSK0Fs]
...
image::page_16_img_3.png[Process in memory,height=80%]
...
image::page_17_img_3.png[Process states,width=50%,align=left]
...
image::page_18_img_3.png[Process control block,width=50%,align=left]
...
image::page_22_img_3.png[Single-threaded and multithreaded processes,height=80%]
...
- Response time: amount of time from submission of a request until the first response is produced (in a time-sharing environment)
