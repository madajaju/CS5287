...
== Core Memory-Management Responsibilities

Video: link:https://youtu.be/geFoSPvQ9jQ[https://youtu.be/geFoSPvQ9jQ]
...
- To run a program of size _n_ pages, find _n_ free frames and load the program
...
image::page_35_img_3.png[page_35_img_3.png]
...
image::page_38_img_3.png[page_38_img_3.png]
...
image::page_39_img_3.png[page_39_img_3.png]
...
- Transfer of a Paged Memory
image::pagedmemory.png[pagedmemory.png]
