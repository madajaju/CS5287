...
image::01_scheduling_flow.png[flow]
...
image::02_filtering_predicates-Filtering__Predicates__Pipeline.png[02_filtering_predicates-Filtering__Predicates__Pipeline.png]
...
== Scoring (Priorities)
image::03_scoring_selection-Scoring_and_Node_Selection.png[03_scoring_selection-Scoring_and_Node_Selection.png]
...
- *Custom Plugin Scores* via the scheduling framework.
...
If binding fails or a node becomes unschedulable, the scheduler retries or leaves the Pod pending.
...
image::06_debugging_scheduling-Debugging_Scheduling.png[06_debugging_scheduling-Debugging_Scheduling.png]
