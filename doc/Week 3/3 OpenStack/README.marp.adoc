...
Video: link:https://youtu.be/ZsRNHEm-usM[https://youtu.be/ZsRNHEm-usM]
...
image::openstack-OpenStack_Core_Services_Deployment.png[openstack-OpenStack_Core_Services_Deployment.png]
