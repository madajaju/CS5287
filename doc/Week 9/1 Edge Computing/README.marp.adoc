...
- *Local Edge*: on-premises gateways and edge appliances
...
== 6. Challenges: Resource and Deployment Constraints
...
== 7. Challenges: Security and Interoperability
