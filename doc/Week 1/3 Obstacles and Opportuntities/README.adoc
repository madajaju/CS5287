...
* See link:https://cloudharmony.com/status[Service Status].
* See the link:https://www.crn.com/slide-shows/cloud/the-10-biggest-cloud-outages-of-2019-so-far-[10 Biggest Cloud Outages Of 2019] for listing of significant outages in 2019.
* See link:https://embracingdigital.org/en/episodes/edt-33/index.html[AWS Thanksgiving Outage 2020]
