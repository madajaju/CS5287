...
Video: link:https://youtu.be/u-skcK6CyL8[Obstacles and Opportunities]
...
* Provider status dashboards and independent monitoring can help identify the scope of an incident.
* *CrowdStrike Falcon update, July 2024:* A faulty content update crashed Windows systems around the world, disrupting
  airlines, hospitals, financial services, and cloud-hosted workloads. The incident illustrates the availability risk
  created by a widely shared software dependency. See
  link:https://www.crowdstrike.com/falcon-content-update-remediation-and-guidance-hub/[CrowdStrike's remediation and guidance hub].
* *Cloudflare Workers KV outage, June 2025:* A failure in a third-party cloud dependency made Workers KV unavailable
  and affected multiple Cloudflare services that depended on it. The incident illustrates why dependency mapping,
  graceful degradation, and tested recovery paths matter. See
  link:https://blog.cloudflare.com/cloudflare-service-outage-june-12-2025/[Cloudflare's incident review].
