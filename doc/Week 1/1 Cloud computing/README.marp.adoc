...
Video link: link:https://youtu.be/NYlDMK28Hyk[Cloud Computing]
...
_Pretty much everything above is what constitutes the cloud._
...
•See The link:http://nvlpubs.nist.gov/nistpubs/Legacy/SP/nistspecialpublication800-145.pdf[NIST Definition of Cloud Computing]
